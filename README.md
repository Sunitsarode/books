...
<img src="https://user-images.githubusercontent.com/29507195/207267672-d422db6c-d89a-4bbe-9822-468a55c15053.png" alt="Vedic Books logo" width="384"/>
...
<img src="https://user-images.githubusercontent.com/29507195/207267857-4ae48890-3fb2-4046-80cf-3256b46c72a0.png" alt="Vedic Books Preview"/>
...
Vedic Books is built on Vue.js and Electron. It is offline by default and uses
...
setup Vedic Books for development and building:
...
To run Vedic Books in development mode (with hot reload, etc):
...
visiting `chrome://inspect` while Vedic Books is running in dev mode.

See more [here](https://www.electronjs.org/docs/latest/tutorial/debugging-main-process#external-debuggers).

#### Build

To build Vedic Books and create an installer:
...
If you want to contribute to Vedic Books, please check our [Contribution Guidelines](https://github.com/frappe/books/blob/master/.github/CONTRIBUTING.md). There are many ways you can contribute even if you don't code:
...
- [Telegram Group](https://t.me/frappebooks): Used for discussions and decisions regarding everything Vedic Books.
- [GitHub Discussions](https://github.com/frappe/books/discussions): Used for discussions around a specific topic.
- [Vedic Books Blog](https://tech.frappebooks.com/): Sporadically updated dev blog regarding the development of this project.

## Maintainers

Vedic Books is currently being maintained by [Mildred Ki'Lya](https://github.com/mildred) and [Isaac-GC](https://github.com/Isaac-GC).
